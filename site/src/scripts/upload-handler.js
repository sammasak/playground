  ...
  card.innerHTML = `
    <div class="bot-card-header">
      ...
      <span class="bot-lang bot-lang-wasm" title="WebAssembly Component">
        <svg width="18" height="18" viewBox="0 0 107.62 107.62" fill="currentColor" aria-hidden="true">
          <path fill="#654ff0" d="M66.12,0c0,.19,0,.38,0,.58a12.34,12.34,0,1,1-24.68,0c0-.2,0-.39,0-.58H0V107.62H107.62V0ZM51.38,96.1,46.14,70.17H46L40.39,96.1H33.18L25,58h7.13L37,83.93h.09L42.94,58h6.67L54.9,84.25H55L60.55,58h7L58.46,96.1Zm39.26,0-2.43-8.48H75.4L73.53,96.1H66.36L75.59,58H86.83L98,96.1Z"/>
          <polygon fill="#654ff0" points="79.87 67.39 76.76 81.37 86.44 81.37 82.87 67.39 79.87 67.39"/>
        </svg>
      </span>
    </div>
