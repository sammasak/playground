"use jco";
import { exit, getEnvironment, getStderr, getStdin, getStdout } from '../bots/preview2-shim-cli.js';
import { Descriptor, filesystemErrorCode, getDirectories } from '../bots/preview2-shim-filesystem.js';
import { Error as Error$1, InputStream, OutputStream } from '../bots/preview2-shim-io.js';
...
GlobalComponentAsyncLowers.define({
  ...
  null,
  {
    ...
    resultLowerFns: [_lowerFlatList({ elemLowerFn: _lowerFlatTuple.bind(null, 0), typeIdx: 2 })],
    getCallbackFn: () => null,
    getPostReturnFn: () => null,
    isCancellable: false,
    memoryIdx: 0,
...
GlobalComponentAsyncLowers.define({
  ...
  null,
  {
    ...
    resultLowerFns: [_lowerFlatResult([{ discriminant: 0, tag: 'ok', lowerFn: _lowerFlatOwn.bind(null, 1), align32: 4 },{ discriminant: 1, tag: 'error', lowerFn: _lowerFlatEnum.bind(null, 4), align32: 1 },])],
    getCallbackFn: () => null,
    getPostReturnFn: () => null,
    isCancellable: false,
    memoryIdx: 0,
...
GlobalComponentAsyncLowers.define({
  ...
  null,
  {
    ...
    resultLowerFns: [_lowerFlatResult([{ discriminant: 0, tag: 'ok', lowerFn: _lowerFlatEnum.bind(null, 5), align32: 1 },{ discriminant: 1, tag: 'error', lowerFn: _lowerFlatEnum.bind(null, 4), align32: 1 },])],
    getCallbackFn: () => null,
    getPostReturnFn: () => null,
    isCancellable: false,
    memoryIdx: 0,
...
GlobalComponentAsyncLowers.define({
  ...
  null,
  {
    ...
    resultLowerFns: [_lowerFlatResult([{ discriminant: 0, tag: 'ok', lowerFn: _lowerFlatRecord([{ field: 'type', lowerFn: _lowerFlatEnum.bind(null, 5), align32: 8 },{ field: 'link-count', lowerFn: _lowerFlatU64, align32: 8 },{ field: 'size', lowerFn: _lowerFlatU64, align32: 8 },{ field: 'data-access-timestamp', lowerFn: _lowerFlatOption.bind(null, 2), align32: 8 },{ field: 'data-modification-timestamp', lowerFn: _lowerFlatOption.bind(null, 2), align32: 8 },{ field: 'status-change-timestamp', lowerFn: _lowerFlatOption.bind(null, 2), align32: 8 },]), align32: 8 },{ discriminant: 1, tag: 'error', lowerFn: _lowerFlatEnum.bind(null, 4), align32: 1 },])],
    getCallbackFn: () => null,
    getPostReturnFn: () => null,
    isCancellable: false,
    memoryIdx: 0,
...
GlobalComponentAsyncLowers.define({
  ...
  null,
  {
    ...
    resultLowerFns: [_lowerFlatList({ elemLowerFn: _lowerFlatTuple.bind(null, 17), typeIdx: 4 })],
    getCallbackFn: () => null,
    getPostReturnFn: () => null,
    isCancellable: false,
    memoryIdx: 0,
...
let engine010ConstructorGame;

class Game{
  constructor() {
    _debugLog('[iface="chess:engine/engine@0.1.0", function="[constructor]game"][Instruction::CallWasm] enter', {
      funcName: '[constructor]game',
      paramCount: 0,
      async: false,
      postReturn: false,
    });
    ...
    const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
      componentIdx: 0,
      isAsync: false,
      entryFnName: 'engine010ConstructorGame',
      getCallbackFn: () => null,
      callbackFnName: 'null',
      errHandling: 'none',
    ...
    let ret = engine010ConstructorGame();
    endCurrentTask(0);
    var handle1 = ret;
    var rsc0 = new.target === Game ? this : Object.create(Game.prototype);
    Object.defineProperty(rsc0, symbolRscHandle, { writable: true, value: handle1});
    ...
    Object.defineProperty(rsc0, symbolDispose, { writable: true, value: function () {
      ...
      exports0['4'](handleTable4[(handle1 << 1) + 1] & ~T_FLAG);
    }});
    _debugLog('[iface="chess:engine/engine@0.1.0", function="[constructor]game"][Instruction::Return]', {
      funcName: '[constructor]game',
      paramCount: 1,
      async: false,
      postReturn: false
...
let engine010StaticGameFromFen;

Game.fromFen = function fromFen(arg0) {
  
  var encodeRes = _utf8AllocateAndEncode(arg0, realloc1, memory0);
  var ptr0= encodeRes.ptr;
  var len0 = encodeRes.len;
  
  _debugLog('[iface="chess:engine/engine@0.1.0", function="[static]game.from-fen"][Instruction::CallWasm] enter', {
    funcName: '[static]game.from-fen',
    paramCount: 2,
    async: false,
    postReturn: false,
  });
  ...
  const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
    componentIdx: 0,
    isAsync: false,
    entryFnName: 'engine010StaticGameFromFen',
    getCallbackFn: () => null,
    callbackFnName: 'null',
  ...
  let ret = engine010StaticGameFromFen(ptr0, len0);
  endCurrentTask(0);
  let variant4;
  switch (dataView(memory0).getUint8(ret + 0, true)) {
    case 0: {
      var handle2 = dataView(memory0).getInt32(ret + 4, true);
      var rsc1 = new.target === Game ? this : Object.create(Game.prototype);
      ...
      Object.defineProperty(rsc1, symbolDispose, { writable: true, value: function () {
        ...
        exports0['4'](handleTable4[(handle2 << 1) + 1] & ~T_FLAG);
      }});
      variant4= {
        tag: 'ok',
        val: rsc1
    ...
    case 1: {
      ...
      switch (dataView(memory0).getUint8(ret + 4, true)) {
        ...
        default: {
          throw new TypeError('invalid discriminant specified for EngineError');
        }
      }
      variant4= {
        tag: 'err',
  ...
  _debugLog('[iface="chess:engine/engine@0.1.0", function="[static]game.from-fen"][Instruction::Return]', {
    funcName: '[static]game.from-fen',
    paramCount: 1,
    async: false,
    postReturn: false
...
let engine010MethodGameGetFen;

Game.prototype.getFen = function getFen() {
  var handle1 = this[symbolRscHandle];
  if (!handle1 || (handleTable4[(handle1 << 1) + 1] & T_FLAG) === 0) {
    throw new TypeError('Resource error: Not a valid "Game" resource.');
  }
  var handle0 = handleTable4[(handle1 << 1) + 1] & ~T_FLAG;
  _debugLog('[iface="chess:engine/engine@0.1.0", function="[method]game.get-fen"][Instruction::CallWasm] enter', {
    funcName: '[method]game.get-fen',
    paramCount: 1,
    async: false,
    postReturn: true,
  });
  ...
  const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
    componentIdx: 0,
    isAsync: false,
    entryFnName: 'engine010MethodGameGetFen',
    getCallbackFn: () => null,
    callbackFnName: 'null',
    errHandling: 'none',
    callingWasmExport: true,
  ...
  let ret = engine010MethodGameGetFen(handle0);
  endCurrentTask(0);
  ...
  _debugLog('[iface="chess:engine/engine@0.1.0", function="[method]game.get-fen"][Instruction::Return]', {
    funcName: '[method]game.get-fen',
    paramCount: 1,
    async: false,
    postReturn: true
...
let engine010MethodGameGetBoardState;

Game.prototype.getBoardState = function getBoardState() {
  var handle1 = this[symbolRscHandle];
  if (!handle1 || (handleTable4[(handle1 << 1) + 1] & T_FLAG) === 0) {
    throw new TypeError('Resource error: Not a valid "Game" resource.');
  }
  var handle0 = handleTable4[(handle1 << 1) + 1] & ~T_FLAG;
  _debugLog('[iface="chess:engine/engine@0.1.0", function="[method]game.get-board-state"][Instruction::CallWasm] enter', {
    funcName: '[method]game.get-board-state',
    paramCount: 1,
    async: false,
    postReturn: true,
  });
  ...
  const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
    componentIdx: 0,
    isAsync: false,
    entryFnName: 'engine010MethodGameGetBoardState',
    getCallbackFn: () => null,
    callbackFnName: 'null',
    errHandling: 'none',
    callingWasmExport: true,
    ...
    switch (dataView(memory0).getUint8(base + 0, true)) {
      ...
      case 1: {
        ...
        switch (dataView(memory0).getUint8(base + 1, true)) {
          ...
          default: {
            throw new TypeError('invalid discriminant specified for PieceType');
          }
        }
        let enum3;
  ...
  var bool7 = dataView(memory0).getUint8(ret + 9, true);
  var bool8 = dataView(memory0).getUint8(ret + 10, true);
  var bool9 = dataView(memory0).getUint8(ret + 11, true);
  var bool10 = dataView(memory0).getUint8(ret + 12, true);
  let variant11;
  switch (dataView(memory0).getUint8(ret + 13, true)) {
    case 0: {
      variant11 = undefined;
      break;
    }
    case 1: {
      variant11 = clampGuest(dataView(memory0).getUint8(ret + 14, true), 0, 255);
      break;
    }
    default: {
      throw new TypeError('invalid variant discriminant for option');
  ...
  var len14 = dataView(memory0).getUint32(ret + 24, true);
  var base14 = dataView(memory0).getUint32(ret + 20, true);
  var result14 = [];
  for (let i = 0; i < len14; i++) {
    ...
    result14.push({
      uciMove: result12,
      resultingFen: result13,
    });
  }
  _debugLog('[iface="chess:engine/engine@0.1.0", function="[method]game.get-board-state"][Instruction::Return]', {
    funcName: '[method]game.get-board-state',
    paramCount: 1,
    async: false,
    postReturn: true
  ...
  const retCopy = {
    ...
    turn: enum6,
    castlingRights: {
      whiteKingside: bool7 == 0 ? false : (bool7 == 1 ? true : throwInvalidBool()),
      whiteQueenside: bool8 == 0 ? false : (bool8 == 1 ? true : throwInvalidBool()),
      blackKingside: bool9 == 0 ? false : (bool9 == 1 ? true : throwInvalidBool()),
      blackQueenside: bool10 == 0 ? false : (bool10 == 1 ? true : throwInvalidBool()),
    },
    enPassant: variant11,
    halfmoveClock: clampGuest(dataView(memory0).getUint16(ret + 16, true), 0, 65535),
    fullmoveNumber: clampGuest(dataView(memory0).getUint16(ret + 18, true), 0, 65535),
    moveHistory: result14,
  };
...
let engine010MethodGameGetLegalMoves;

Game.prototype.getLegalMoves = function getLegalMoves() {
  var handle1 = this[symbolRscHandle];
  if (!handle1 || (handleTable4[(handle1 << 1) + 1] & T_FLAG) === 0) {
    throw new TypeError('Resource error: Not a valid "Game" resource.');
  }
  var handle0 = handleTable4[(handle1 << 1) + 1] & ~T_FLAG;
  _debugLog('[iface="chess:engine/engine@0.1.0", function="[method]game.get-legal-moves"][Instruction::CallWasm] enter', {
    funcName: '[method]game.get-legal-moves',
    paramCount: 1,
    async: false,
    postReturn: true,
  });
  ...
  const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
    componentIdx: 0,
    isAsync: false,
    entryFnName: 'engine010MethodGameGetLegalMoves',
    getCallbackFn: () => null,
    callbackFnName: 'null',
    errHandling: 'none',
    callingWasmExport: true,
  ...
  let ret = engine010MethodGameGetLegalMoves(handle0);
  endCurrentTask(0);
  ...
  _debugLog('[iface="chess:engine/engine@0.1.0", function="[method]game.get-legal-moves"][Instruction::Return]', {
    funcName: '[method]game.get-legal-moves',
    paramCount: 1,
    async: false,
    postReturn: true
...
let engine010MethodGameMakeMove;

Game.prototype.makeMove = function makeMove(arg1) {
  var handle1 = this[symbolRscHandle];
  if (!handle1 || (handleTable4[(handle1 << 1) + 1] & T_FLAG) === 0) {
    throw new TypeError('Resource error: Not a valid "Game" resource.');
  }
  ...
  _debugLog('[iface="chess:engine/engine@0.1.0", function="[method]game.make-move"][Instruction::CallWasm] enter', {
    funcName: '[method]game.make-move',
    paramCount: 3,
    async: false,
    postReturn: false,
  });
  ...
  const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
    componentIdx: 0,
    isAsync: false,
    entryFnName: 'engine010MethodGameMakeMove',
    getCallbackFn: () => null,
    callbackFnName: 'null',
    errHandling: 'throw-result-err',
    callingWasmExport: true,
  ...
  let ret = engine010MethodGameMakeMove(handle0, ptr2, len2);
  endCurrentTask(0);
  let variant4;
  switch (dataView(memory0).getUint8(ret + 0, true)) {
    case 0: {
  ...
  _debugLog('[iface="chess:engine/engine@0.1.0", function="[method]game.make-move"][Instruction::Return]', {
    funcName: '[method]game.make-move',
    paramCount: 1,
    async: false,
    postReturn: false
...
let engine010MethodGameGetGameResult;
...
Game.prototype.getGameResult = function getGameResult() {
  ...
  var handle0 = handleTable4[(handle1 << 1) + 1] & ~T_FLAG;
  _debugLog('[iface="chess:engine/engine@0.1.0", function="[method]game.get-game-result"][Instruction::CallWasm] enter', {
    funcName: '[method]game.get-game-result',
    paramCount: 1,
    async: false,
    postReturn: false,
  });
  ...
  const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
    componentIdx: 0,
    isAsync: false,
    entryFnName: 'engine010MethodGameGetGameResult',
    getCallbackFn: () => null,
    callbackFnName: 'null',
    errHandling: 'none',
    callingWasmExport: true,
  ...
  let ret = engine010MethodGameGetGameResult(handle0);
  endCurrentTask(0);
  let enum2;
  switch (ret) {
    case 0: {
    ...
    default: {
      throw new TypeError('invalid discriminant specified for GameResult');
    }
  }
  _debugLog('[iface="chess:engine/engine@0.1.0", function="[method]game.get-game-result"][Instruction::Return]', {
    funcName: '[method]game.get-game-result',
    paramCount: 1,
    async: false,
    postReturn: false
...
let engine010MethodGameIsCheck;

Game.prototype.isCheck = function isCheck() {
  var handle1 = this[symbolRscHandle];
  if (!handle1 || (handleTable4[(handle1 << 1) + 1] & T_FLAG) === 0) {
    throw new TypeError('Resource error: Not a valid "Game" resource.');
  }
  var handle0 = handleTable4[(handle1 << 1) + 1] & ~T_FLAG;
  _debugLog('[iface="chess:engine/engine@0.1.0", function="[method]game.is-check"][Instruction::CallWasm] enter', {
    funcName: '[method]game.is-check',
    paramCount: 1,
    async: false,
    postReturn: false,
  });
  ...
  const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
    componentIdx: 0,
    isAsync: false,
    entryFnName: 'engine010MethodGameIsCheck',
    getCallbackFn: () => null,
    callbackFnName: 'null',
    errHandling: 'none',
    callingWasmExport: true,
  ...
  let ret = engine010MethodGameIsCheck(handle0);
  endCurrentTask(0);
  var bool2 = ret;
  _debugLog('[iface="chess:engine/engine@0.1.0", function="[method]game.is-check"][Instruction::Return]', {
    funcName: '[method]game.is-check',
    paramCount: 1,
    async: false,
    postReturn: false
...
let engine010MethodGameGetTurn;
...
Game.prototype.getTurn = function getTurn() {
  ...
  var handle0 = handleTable4[(handle1 << 1) + 1] & ~T_FLAG;
  _debugLog('[iface="chess:engine/engine@0.1.0", function="[method]game.get-turn"][Instruction::CallWasm] enter', {
    funcName: '[method]game.get-turn',
    paramCount: 1,
    async: false,
    postReturn: false,
  });
  ...
  const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
    componentIdx: 0,
    isAsync: false,
    entryFnName: 'engine010MethodGameGetTurn',
    getCallbackFn: () => null,
    callbackFnName: 'null',
    errHandling: 'none',
    callingWasmExport: true,
  ...
  let ret = engine010MethodGameGetTurn(handle0);
  endCurrentTask(0);
  let enum2;
  switch (ret) {
    case 0: {
  ...
  _debugLog('[iface="chess:engine/engine@0.1.0", function="[method]game.get-turn"][Instruction::Return]', {
    funcName: '[method]game.get-turn',
    paramCount: 1,
    async: false,
    postReturn: false
...
let engine010MethodGameGetPieceAt;

Game.prototype.getPieceAt = function getPieceAt(arg1) {
  var handle1 = this[symbolRscHandle];
  if (!handle1 || (handleTable4[(handle1 << 1) + 1] & T_FLAG) === 0) {
    throw new TypeError('Resource error: Not a valid "Game" resource.');
  }
  var handle0 = handleTable4[(handle1 << 1) + 1] & ~T_FLAG;
  _debugLog('[iface="chess:engine/engine@0.1.0", function="[method]game.get-piece-at"][Instruction::CallWasm] enter', {
    funcName: '[method]game.get-piece-at',
    paramCount: 2,
    async: false,
    postReturn: false,
  });
  ...
  const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
    componentIdx: 0,
    isAsync: false,
    entryFnName: 'engine010MethodGameGetPieceAt',
    getCallbackFn: () => null,
    callbackFnName: 'null',
    errHandling: 'none',
    callingWasmExport: true,
  ...
  let ret = engine010MethodGameGetPieceAt(handle0, toUint8(arg1));
  endCurrentTask(0);
  let variant4;
  switch (dataView(memory0).getUint8(ret + 0, true)) {
    case 0: {
    ...
    case 1: {
      ...
      let enum3;
      switch (dataView(memory0).getUint8(ret + 2, true)) {
        case 0: {
          enum3 = 'white';
          break;
        }
  ...
  _debugLog('[iface="chess:engine/engine@0.1.0", function="[method]game.get-piece-at"][Instruction::Return]', {
    funcName: '[method]game.get-piece-at',
    paramCount: 1,
    async: false,
    postReturn: false
...
let engine010MethodGameGetMoveHistory;

Game.prototype.getMoveHistory = function getMoveHistory() {
  var handle1 = this[symbolRscHandle];
  if (!handle1 || (handleTable4[(handle1 << 1) + 1] & T_FLAG) === 0) {
    throw new TypeError('Resource error: Not a valid "Game" resource.');
  }
  var handle0 = handleTable4[(handle1 << 1) + 1] & ~T_FLAG;
  _debugLog('[iface="chess:engine/engine@0.1.0", function="[method]game.get-move-history"][Instruction::CallWasm] enter', {
    funcName: '[method]game.get-move-history',
    paramCount: 1,
    async: false,
    postReturn: true,
  });
  ...
  const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
    componentIdx: 0,
    isAsync: false,
    entryFnName: 'engine010MethodGameGetMoveHistory',
    getCallbackFn: () => null,
    callbackFnName: 'null',
    errHandling: 'none',
    callingWasmExport: true,
  ...
  let ret = engine010MethodGameGetMoveHistory(handle0);
  endCurrentTask(0);
  ...
  for (let i = 0; i < len4; i++) {
    ...
    result4.push({
      uciMove: result2,
      resultingFen: result3,
    });
  }
  _debugLog('[iface="chess:engine/engine@0.1.0", function="[method]game.get-move-history"][Instruction::Return]', {
    funcName: '[method]game.get-move-history',
    paramCount: 1,
    async: false,
    postReturn: true
...
Game.prototype.reset = function reset() {
  ...
  var handle0 = handleTable4[(handle1 << 1) + 1] & ~T_FLAG;
  _debugLog('[iface="chess:engine/engine@0.1.0", function="[method]game.reset"][Instruction::CallWasm] enter', {
    funcName: '[method]game.reset',
    paramCount: 1,
    async: false,
    postReturn: false,
  });
  ...
  const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
    componentIdx: 0,
    isAsync: false,
    entryFnName: 'engine010MethodGameReset',
    getCallbackFn: () => null,
    callbackFnName: 'null',
    errHandling: 'none',
    callingWasmExport: true,
  ...
  let ret;engine010MethodGameReset(handle0);
  endCurrentTask(0);
  _debugLog('[iface="chess:engine/engine@0.1.0", function="[method]game.reset"][Instruction::Return]', {
    funcName: '[method]game.reset',
    paramCount: 0,
    async: false,
    postReturn: false
...
const $init = (() => {
  let gen = (function* _initGenerator () {
    const module0 = fetchCompile(new URL('./chess_engine_component.core.wasm', import.meta.url));
    const module1 = fetchCompile(new URL('./chess_engine_component.core2.wasm', import.meta.url));
    const module2 = base64Compile('');
    const module3 = base64Compile('');
    ({ exports: exports0 } = yield instantiateCore(yield module2));
    ({ exports: exports1 } = yield instantiateCore(yield module0, {
      '[export]chess:engine/engine@0.1.0': {
        '[resource-drop]game': trampoline1,
        '[resource-new]game': trampoline0,
      },
    ...
    ({ exports: exports3 } = yield instantiateCore(yield module3, {
      '': {
        ...
        '4': exports1['chess:engine/engine@0.1.0#[dtor]game'],
        '5': trampoline10,
        '6': trampoline11,
        '7': trampoline12,
        '8': trampoline13,
    ...
    postReturn0 = exports1['cabi_post_chess:engine/engine@0.1.0#[method]game.get-fen'];
    postReturn1 = exports1['cabi_post_chess:engine/engine@0.1.0#[method]game.get-board-state'];
    postReturn2 = exports1['cabi_post_chess:engine/engine@0.1.0#[method]game.get-legal-moves'];
    postReturn3 = exports1['cabi_post_chess:engine/engine@0.1.0#[method]game.get-move-history'];
    engine010ConstructorGame = exports1['chess:engine/engine@0.1.0#[constructor]game'];
    engine010StaticGameFromFen = exports1['chess:engine/engine@0.1.0#[static]game.from-fen'];
    engine010MethodGameGetFen = exports1['chess:engine/engine@0.1.0#[method]game.get-fen'];
    engine010MethodGameGetBoardState = exports1['chess:engine/engine@0.1.0#[method]game.get-board-state'];
    engine010MethodGameGetLegalMoves = exports1['chess:engine/engine@0.1.0#[method]game.get-legal-moves'];
    engine010MethodGameMakeMove = exports1['chess:engine/engine@0.1.0#[method]game.make-move'];
    engine010MethodGameGetGameResult = exports1['chess:engine/engine@0.1.0#[method]game.get-game-result'];
    engine010MethodGameIsCheck = exports1['chess:engine/engine@0.1.0#[method]game.is-check'];
    engine010MethodGameGetTurn = exports1['chess:engine/engine@0.1.0#[method]game.get-turn'];
    engine010MethodGameGetPieceAt = exports1['chess:engine/engine@0.1.0#[method]game.get-piece-at'];
    engine010MethodGameGetMoveHistory = exports1['chess:engine/engine@0.1.0#[method]game.get-move-history'];
    engine010MethodGameReset = exports1['chess:engine/engine@0.1.0#[method]game.reset'];
  })();
...
export { engine010 as engine, engine010 as 'chess:engine/engine@0.1.0',  }