...
const $init = (() => {
  let gen = (function* _initGenerator () {
    const module0 = fetchCompile(new URL('./random_bot_component.core.wasm', import.meta.url));
    const module1 = fetchCompile(new URL('./random_bot_component.core2.wasm', import.meta.url));
    const module2 = base64Compile('');
    const module3 = base64Compile('');
