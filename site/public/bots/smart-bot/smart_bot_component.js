"use jco";
import { getFen, getLegalMoves, log } from '../bot-host.js';
...
let lowered_import_5_metadata = {
  qualifiedImportFn: 'chess:bot/host@0.1.0#get-fen',
  moduleIdx: null,
};


function trampoline9(arg0) {
  _debugLog('[iface="chess:bot/host@0.1.0", function="get-fen"] [Instruction::CallInterface] (sync, @ enter)');
  let hostProvided = false;
  hostProvided = getFen?._isHostProvided;
  ...
  _debugLog('[iface="chess:bot/host@0.1.0", function="get-fen"][Instruction::Return]', {
    funcName: 'get-fen',
    paramCount: 0,
    async: false,
    postReturn: false
...
GlobalComponentAsyncLowers.define({
  ...
  null,
  {
    ...
    resultLowerFns: [_lowerFlatList({ elemLowerFn: _lowerFlatStringUTF8, typeIdx: 0 })],
    getCallbackFn: () => null,
    getPostReturnFn: () => null,
    isCancellable: false,
    memoryIdx: 0,
...
GlobalComponentAsyncLowers.define({
  ...
  null,
  {
    ...
    resultLowerFns: [_lowerFlatList({ elemLowerFn: _lowerFlatTuple.bind(null, 3), typeIdx: 1 })],
    getCallbackFn: () => null,
    getPostReturnFn: () => null,
    isCancellable: false,
    memoryIdx: 0,
...
GlobalComponentAsyncLowers.define({
  ...
  null,
  {
    ...
    resultLowerFns: [_lowerFlatResult([{ discriminant: 0, tag: 'ok', lowerFn: _lowerFlatRecord([{ field: 'type', lowerFn: _lowerFlatEnum.bind(null, 2), align32: 8 },{ field: 'link-count', lowerFn: _lowerFlatU64, align32: 8 },{ field: 'size', lowerFn: _lowerFlatU64, align32: 8 },{ field: 'data-access-timestamp', lowerFn: _lowerFlatOption.bind(null, 0), align32: 8 },{ field: 'data-modification-timestamp', lowerFn: _lowerFlatOption.bind(null, 0), align32: 8 },{ field: 'status-change-timestamp', lowerFn: _lowerFlatOption.bind(null, 0), align32: 8 },]), align32: 8 },{ discriminant: 1, tag: 'error', lowerFn: _lowerFlatEnum.bind(null, 1), align32: 1 },])],
    getCallbackFn: () => null,
    getPostReturnFn: () => null,
    isCancellable: false,
    memoryIdx: 0,
...
GlobalComponentAsyncLowers.define({
  ...
  null,
  {
    ...
    componentIdx: 0,
    isAsync: false,
    paramLiftFns: [_liftFlatBorrow.bind(null, 1),_liftFlatList.bind(null, 2)],
...
GlobalComponentAsyncLowers.define({
  ...
  null,
  {
    ...
    resultLowerFns: [_lowerFlatList({ elemLowerFn: _lowerFlatTuple.bind(null, 19), typeIdx: 3 })],
    getCallbackFn: () => null,
    getPostReturnFn: () => null,
    isCancellable: false,
    memoryIdx: 0,
...
const $init = (() => {
  let gen = (function* _initGenerator () {
    const module0 = fetchCompile(new URL('./smart_bot_component.core.wasm', import.meta.url));
    const module1 = fetchCompile(new URL('./smart_bot_component.core2.wasm', import.meta.url));
    const module2 = base64Compile('');
    const module3 = base64Compile('');
    ({ exports: exports0 } = yield instantiateCore(yield module2));
    ({ exports: exports1 } = yield instantiateCore(yield module0, {
      'chess:bot/host@0.1.0': {
        'get-fen': exports0['1'],
        'get-legal-moves': exports0['2'],
        log: exports0['0'],
      },
