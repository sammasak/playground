...
export type * as ChessBotHost010 from './interfaces/chess-bot-host.js'; // import chess:bot/host@0.1.0
export type * as ChessTypesTypes010 from './interfaces/chess-types-types.js'; // import chess:types/types@0.1.0
...
export * as bot from './interfaces/chess-bot-bot.js'; // export chess:bot/bot@0.1.0
