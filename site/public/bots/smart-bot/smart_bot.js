...
const $init = (() => {
  let gen = (function* _initGenerator () {
    const module0 = fetchCompile(new URL('./smart_bot.core.wasm', import.meta.url));
    const module1 = fetchCompile(new URL('./smart_bot.core2.wasm', import.meta.url));
    const module2 = base64Compile('');
    ...
    ({ exports: exports1 } = yield instantiateCore(yield module0, {
      'chess:bot/host@0.1.0': {
        'get-board': exports0['2'],
        'get-legal-moves': exports0['1'],
        log: exports0['0'],
      },
